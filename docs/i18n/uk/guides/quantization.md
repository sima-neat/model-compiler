...
На цій сторінці описано квантування після навчання (PTQ). Якщо модель PyTorch можна перенавчити, скористайтеся [навчанням з урахуванням квантування](/compile-a-model/quantization-aware-training/), щоб симулювати ефекти INT8 під час тонкого налаштування та експортувати стандартну модель QDQ ONNX. Поверніться до цього посібника, щоб імпортувати та скомпілювати експортовану модель.
:::
